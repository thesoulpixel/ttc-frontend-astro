  ...
  collections: {
    posts: collection({
      ...
      schema: {
        ...
        featuredImage: index.image({
          label: "Cover Image",
          directory: "public/images/posts",
          publicPath: "/images/posts/"
        }),
        seo: index.object({
          title: index.text({ label: "SEO Title" }),
          description: index.text({
            label: "Meta Description",
            multiline: true
          }),
          canonical: index.text({ label: "Canonical URL" }),
          noindex: index.checkbox({ label: "No Index", defaultValue: false })
        }),
