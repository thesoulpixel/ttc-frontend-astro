...
async function getPostsByCategory(categoryName, limit = 10, after = null) {
  ...
  // CRITICAL FIX: Do NOT return fallback data if we are paginating (loading more).
  // If paginating and it fails, we want the frontend to show an error or stop, not show mock data.
  if (after) {
...
export { getAllCategories as a, getPostBySlug as b, getAllPostSlugs as c, getPostsByCategory as g };
